...
export class MatPasswordStrengthInfoComponent implements OnInit {
  ...
  @Input()
  lowerCaseCriteriaMsg = "Ít nhất 1 kí tự thường";

  @Input()
  upperCaseCriteriaMsg = "Ít nhất 1 kí tự in hoa";

  @Input()
  digitsCriteriaMsg = "Ít nhất 1 chữ số";

  @Input()
  specialCharsCriteriaMsg = "Ít nhất 1 kí tự đặc biệt";
  ...
  ngOnInit(): void {
    if (!this.minCharsCriteriaMsg) {
      this.minCharsCriteriaMsg = `Độ dài tối thiểu ${this.passwordComponent.min} kí tự`;
    }
  }
}
